...
PARAM$finalmodel$num_iterations <- 801
PARAM$finalmodel$learning_rate <- 0.012278715818695
PARAM$finalmodel$feature_fraction <- 0.532434772949988
PARAM$finalmodel$min_data_in_leaf <- 107
PARAM$finalmodel$num_leaves <-702
